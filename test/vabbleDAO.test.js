...
describe('VabbleDAO', function () {
  ...
  beforeEach(async function () {    
    ...
    await this.stakingContract.connect(this.customer4).stakeToken(getBigNumber(300), {from: this.customer4.address})
    await this.stakingContract.connect(this.customer5).stakeToken(getBigNumber(300), {from: this.customer5.address})
    await this.stakingContract.connect(this.customer6).stakeToken(getBigNumber(300), {from: this.customer6.address})
