...
describe('VabbleDAO', function () {
  ...
  beforeEach(async function () {    
    ...
    await this.DAI.connect(this.auditor).transfer(this.customer1.address, getBigNumber(10000), {from: this.auditor.address});
    await this.DAI.connect(this.auditor).transfer(this.customer2.address, getBigNumber(10000), {from: this.auditor.address});
    await this.DAI.connect(this.auditor).transfer(this.customer3.address, getBigNumber(10000), {from: this.auditor.address});
    // Transfering DAI token to studio1, 2, 3
    await this.DAI.connect(this.auditor).transfer(this.studio1.address, getBigNumber(1000000), {from: this.auditor.address});
    await this.DAI.connect(this.auditor).transfer(this.studio2.address, getBigNumber(1000000), {from: this.auditor.address});
    await this.DAI.connect(this.auditor).transfer(this.studio3.address, getBigNumber(1000000), {from: this.auditor.address});
    ...
    await this.EXM.connect(this.auditor).transfer(this.customer1.address, getBigNumber(10000), {from: this.auditor.address});
    await this.EXM.connect(this.auditor).transfer(this.customer2.address, getBigNumber(10000), {from: this.auditor.address});
    await this.EXM.connect(this.auditor).transfer(this.customer3.address, getBigNumber(10000), {from: this.auditor.address});
    // Transfering EXM token to studio1, 2, 3
    await this.EXM.connect(this.auditor).transfer(this.studio1.address, getBigNumber(10000), {from: this.auditor.address});
    await this.EXM.connect(this.auditor).transfer(this.studio2.address, getBigNumber(10000), {from: this.auditor.address});
    await this.EXM.connect(this.auditor).transfer(this.studio3.address, getBigNumber(10000), {from: this.auditor.address});
  ...
  it('approve_funding logic with only VAB', async function () {
    ...
    const depositAmount = getBigNumber(10000)
    ...
    // expect(BigNumber.from(totalRewardAmount_1.toString()).sub(BigNumber.from(totalRewardAmount_0.toString())))
    // .to.be.equal(depositAmount.mul(200).div(10000))
  });

  it('approve_funding logic with other tokens(EXM)', async function () {    
    const raiseAmounts = [getBigNumber(5000, 6), getBigNumber(10000, 6), getBigNumber(30000, 6), getBigNumber(30000, 6)];
