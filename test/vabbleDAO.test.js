...
describe('VabbleDAO', function () {
  ...
  beforeEach(async function () {    
    ...
    await this.EXM.connect(this.auditor).transfer(this.studio1.address, getBigNumber(100000), {from: this.auditor.address});
    await this.EXM.connect(this.auditor).transfer(this.studio2.address, getBigNumber(100000), {from: this.auditor.address});
    await this.EXM.connect(this.auditor).transfer(this.studio3.address, getBigNumber(100000), {from: this.auditor.address});
