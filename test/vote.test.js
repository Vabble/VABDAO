...
describe('Vote', function () {
  ...
  it('VoteToAgent', async function () {    
    ...
    await expect(
      this.voteContract.connect(this.customer1).voteToAgent(this.newAuditor.address, voteInfo[0], {from: this.customer1.address})
    ...
    // await this.voteContract.connect(this.customer1).voteToAgent(this.newAuditor.address, voteInfo[0], {from: this.customer1.address})
